...
<div class="wrap">
	<div id="welcome-panel" class="welcome-panel">
		<div class="welcome-panel-content">
			<h1 class="text-center"><em><a href="http://awplife.com/product/slider-responsive-slideshow-premium/">Slider Responsive Slideshow Premium Plugin</a></em></h1>
			...
			<div class="thumbnail col-md-8"><br>
				...
				<h2 class="text-center"><a class="btn btn-primary btn-lg" href="http://awplife.com/account/signup/slider-responsive-slideshow">Purchase Now</a></h2><br>
			</div>
			...
			<div class="col-md-12">
				<div class="row awp_bale_offer text-center">
					<div class="col-md-6">
						<h1>Plugin's Bale Offer - 18+ Plugins</h1>
